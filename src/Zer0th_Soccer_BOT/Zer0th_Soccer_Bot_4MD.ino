...
void loop() {
  ...
  switch (serialA) {
    ...
    case 'G':
      ...
      analogWrite(enablem1Pin3, 20);//down left
      analogWrite(enablem2Pin3, defaultSpeed);//down right

      analogWrite(enablem3Pin3, defaultSpeed);//up right
      analogWrite(enablem4Pin3, 20);//up left
      break;
    ...
    case 'I':
      ...
      analogWrite(enablem1Pin3, defaultSpeed);//down left
      analogWrite(enablem2Pin3, 20);//down right

      analogWrite(enablem3Pin3, 20);//up right
      analogWrite(enablem4Pin3, defaultSpeed);//up left
      break;
